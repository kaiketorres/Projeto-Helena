...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            ...
            case "19/6": titulo = "15 de Maio"; mensagem = "<section class='text-center'><p class='letra-vermelha'><strong>Este momento está sendo escrito agora...</strong></p></section>";break;
            case "final": titulo = "15 de Maio"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>Um dia muito especial <br><span class='letra2 letra-vermelha'>💜</span></strong></p></section>";break;
        }
